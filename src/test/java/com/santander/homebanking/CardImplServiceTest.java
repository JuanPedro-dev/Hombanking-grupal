...
public class CardImplServiceTest {
    ...
    List<Card> cards = Arrays.asList(
            new CreditCard("Juan Pedro Trionfini", "1111-2222-3333-4444", 123, LocalDate.parse("2023-01-01"), LocalDate.parse("2027-09-08"), CardColor.TITANIUM, CardType.CREDIT, "1234", 200000.0, 200000.0),
            new DebitCard("Juan Pedro Trionfini", "2222-3333-4444-5555", 123, LocalDate.parse("2023-01-01"), LocalDate.parse("2027-09-08"), CardColor.GOLD, CardType.DEBIT, "1234")
    );
    ...
    public void newBasicCardTest(){
        ...
        assertThat(testCardDTO.getCardHolder(), is("Juan Pedro Trionfini"));
