...
public class CreditCardImplServiceTests {
    ...
    CreditCard creditCard = new CreditCard("Juan Pedro Trionfini", "1111-2222-3333-4444", 123, LocalDate.parse("2023-01-01"), LocalDate.parse("2027-09-08"), CardColor.TITANIUM, CardType.CREDIT, "1234", 200000.0, 200000.0);
    CardDTO cardDTO = new CardDTO(1L,"Juan Pedro Trionfini", "1111-2222-3333-4444", 123, LocalDate.parse("2023-01-01"), LocalDate.parse("2027-09-08"), CardColor.TITANIUM, CardType.CREDIT, "1234");
