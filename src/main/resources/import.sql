--INSERT INTO client (first_name, last_name, email) VALUES ('Juan Pedro', 'Trionfini', 'juanpedro.developer@gmail.com');
--INSERT INTO client (first_name, last_name, email) VALUES ('Admin', 'Admin', 'admin@admin.com');
--INSERT INTO account (number, creation_date, balance, client_id) VALUES ('VIN001', '2023-01-01', 5000, 1L);
--INSERT INTO account (number, creation_date, balance, client_id) VALUES ('VIN002', '2023-01-01', 7500, 1L);
--INSERT INTO account (number, creation_date, balance, client_id) VALUES ('VIN003', '2023-01-01', 9000, 2L);
--INSERT INTO account (number, creation_date, balance, client_id) VALUES ('VIN004', '2023-01-01', 6500, 2L);
